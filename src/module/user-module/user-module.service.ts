...
export class UserModuleService {
	...
	async updateMe(userId: string, data: UserModuleEntity, imageFile?: File): Promise<ApiResponse> {
		...
		await userModuleModel.updateOne({ _id: userId }, {
			$set: {
				...data,
				avatar: imageUrl
			}
		...
		return { message: "Dados atualizados com sucesso!", errors: [] };
	}
}